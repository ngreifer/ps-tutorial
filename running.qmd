...
In this section, we describe how to run a matching or weighting analysis. First, we describe the steps and the choices one must make in each step, and then we provide some examples for how to run the described analysis using R.
